  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(131, 138, 182, 1);fontSize:28px;">大学学术交流论坛注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='banzhu'" class="input-group">
			   <div class="label">版主账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.banzhuzhanghao" class="input" type="text" placeholder="版主账号">
			   </div>
			 </div> -->
			<el-form-item label="版主账号" class="input" v-if="tableName=='banzhu'">
			  <el-input v-model="ruleForm.banzhuzhanghao" autocomplete="off" placeholder="版主账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banzhu'" class="input-group">
			   <div class="label">版主姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.banzhuxingming" class="input" type="text" placeholder="版主姓名">
			   </div>
			 </div> -->
			<el-form-item label="版主姓名" class="input" v-if="tableName=='banzhu'">
			  <el-input v-model="ruleForm.banzhuxingming" autocomplete="off" placeholder="版主姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banzhu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='banzhu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='banzhu'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='banzhu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banzhu'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='banzhu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.banzhuzhanghao) && `banzhu` == this.tableName){
        this.$message.error(`版主账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `banzhu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`banzhu` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`banzhu` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
