<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请模块" prop="shenqingmokuai">
          <el-input v-model="ruleForm.shenqingmokuai" 
              placeholder="申请模块" clearable  :readonly="ro.shenqingmokuai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请模块" prop="shenqingmokuai">
              <el-input v-model="ruleForm.shenqingmokuai" 
                placeholder="申请模块" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenqingyuanyin = true;
          ...
          if(o=='shenqingmokuai'){
            this.ruleForm.shenqingmokuai = obj[o];
	    this.ro.shenqingmokuai = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shenqingbanzhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenqingbanzhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
