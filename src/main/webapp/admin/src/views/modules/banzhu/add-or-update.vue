<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="版主账号" prop="banzhuzhanghao">
          <el-input v-model="ruleForm.banzhuzhanghao" 
              placeholder="版主账号" clearable  :readonly="ro.banzhuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="版主账号" prop="banzhuzhanghao">
              <el-input v-model="ruleForm.banzhuzhanghao" 
                placeholder="版主账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="版主姓名" prop="banzhuxingming">
          <el-input v-model="ruleForm.banzhuxingming" 
              placeholder="版主姓名" clearable  :readonly="ro.banzhuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="版主姓名" prop="banzhuxingming">
              <el-input v-model="ruleForm.banzhuxingming" 
                placeholder="版主姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="管理模块" prop="guanlimokuai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="管理模块"
                  v-model="ruleForm.guanlimokuai" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guanlimokuai" label="管理模块" prop="guanlimokuai">
                    <span>{{ruleForm.guanlimokuai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	money : false,
      ...
      rules: {
          banzhuzhanghao: [
                { required: true, message: '版主账号不能为空', trigger: 'blur' },
          ],
          banzhuxingming: [
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
          ...
          if(o=='guanlimokuai'){
            this.ruleForm.guanlimokuai = obj[o];
	    this.ro.guanlimokuai = true;
            continue;
          }
          if(o=='money'){
